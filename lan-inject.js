...
st.textContent="@media (max-width:767px){html,body{touch-action:manipulation;-webkit-text-size-adjust:100%;text-size-adjust:100%}:root{--dsh-chat-content-width:calc(100vw - 20px) !important;--dsh-composer-side-clearance:12px !important;--dsh-composer-dock-inset:env(safe-area-inset-bottom) !important}input,textarea{font-size:16px !important;min-height:44px}button{min-height:40px}.VOzbGW_rail{position:static !important;width:100% !important;height:auto !important;flex-direction:row !important;overflow-x:auto !important}.VOzbGW_navList{display:flex !important;flex-direction:row !important;overflow-x:auto !important}.VOzbGW_panel{width:100% !important;margin:0 !important}}";
